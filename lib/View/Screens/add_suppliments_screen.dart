...
class AddSupplementsScreen extends StatefulWidget {
  const AddSupplementsScreen({Key? key}) : super(key: key);

  @override
  State<AddSupplementsScreen> createState() => _AddSupplementsScreenState();
}

class _AddSupplementsScreenState extends State<AddSupplementsScreen> {
